...
class IntelReportAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        ("Westside Aviation Resources", {'fields':['westside_rotors', 'westside_firebosses', 'westside_vlat', 'westside_ang']}),
        ("Eastside Aviation Resources", {'fields':['eastside_rotors', 'eastside_firebosses', 'eastside_vlat', 'eastside_ang']}),
        ("In Region Aviation Resources", {'fields':['in_region_rotors', 'in_region_firebosses', 'in_region_vlat', 'in_region_ang']}),
    ]
